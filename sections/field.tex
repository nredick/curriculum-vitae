...
\field[
    ...
    who={UC Davis, University of Oregon, \& USGS Cascade Volcano Observatory},
    location={Mt. Rainier \& Mt. St. Helens, WA},
    date=Sept 2025,
    length={3 days},
]{
    \begin{cvitemize}
        \item Assisted in the recovery of seismic nodes deployed in Aug 2025 along the Tahoma Creek drainage.
        \item Assisted in deployment of 87 seismic nodes during helicopter-enabled deployment on Mt. St. Helens.
