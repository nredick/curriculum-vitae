...
\experience[
    ...
    % Supervisors: Carl Stahmer, Oliver Kreylos
    \begin{cvitemize}
        \item Developer for Vrui, an open-source C{\small++} toolkit for scientific analysis \& visualization in extended reality.
        \item Rebuilding application documentation to improve accessibility \& reach.
        \item Supervising \& mentoring an undergraduate student interning at the DataLab.
    \end{cvitemize}
}
...
\experience[
    ...
    % Supervisors: Eric Cowgill (GEL 50L, GEL 101L), Gregory Funston (GEL 1)
    \begin{cvitemize}
        \item Teaching assistant in the Dept. of Earth \& Planetary Sciences.
        \item Taught lab courses, field excursions, \& dicussion sections over three quarters.
    \end{cvitemize}
}
...
\experience[
    ...
    location={Montr\'eal, QC}, % use {} when you need a comma in the field
    date=\daterange{2023/07/31}{2024/08/16},
    % link=https://www.morganstanley.com
]{
    % Supervisors: Patrick Ayoup, Bruno Navert
    \begin{cvitemize}
        \item Worked collaboratively to provide agile metrics analysis for internal development teams globally, user support, \& documentation.
